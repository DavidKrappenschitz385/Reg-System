...
$stmt = mysqli_prepare($db_con, "SELECT * FROM `users` WHERE `username` = ? AND `role` = 'coach' AND `status` = 'approved' LIMIT 1");
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="list-group">
                ...
                <a href="index.php?page=create-team" class="list-group-item list-group-item-action"><i class="fas fa-users-cog"></i> Create Team</a>
                <a href="index.php?page=create-player" class="list-group-item list-group-item-action"><i class="fa fa-user-plus"></i> Create Player</a>
